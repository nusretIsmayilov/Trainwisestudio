...
import TodayTaskPage from "./pages/customer/TodayTaskPage";
import TaskHistoryPage from "./pages/customer/TaskHistoryPage";
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoutesLayout />}>
              ...
              <Route element={<CustomerLayout />}>
                ...
                <Route
                  path="/customer/today-task"
                  element={
                    <CustomerRouteGuard skeletonType="dashboard">
                      <TodayTaskPage />
                    </CustomerRouteGuard>
                  }
                />
