...
export const mockLibrary: LibraryItem[] = [
  {
    ...
    name: "Barbell Squat",
    introduction:
      "The king of all leg exercises, essential for lower body strength.",
    muscleGroup: "Quads, Glutes",
    howTo: [
      {
        id: "h1",
        type: "step",
        value: "Place the bar across your upper back.",
      },
    ],
  ...
  },
  {
    ...
    introduction:
      "A technique for regulating the nervous system and reducing stress.",
    content: [
      { id: "c1", type: "soundfile", value: "link-to-audio.mp3" },
      {
        id: "c2",
        type: "text",
        value: "Inhale for 4, hold for 4, exhale for 4, hold for 4.",
      },
    ],
    isCustom: true,
  },
