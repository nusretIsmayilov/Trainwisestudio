...
const CATEGORY_DETAILS: Record<
  LibraryCategory,
  { title: string; emoji: string; defaultHeroUrl: string; intro: string }
> = {
  exercise: {
    title: "New Fitness Item",
    emoji: "💪",
    defaultHeroUrl:
      "https://images.unsplash.com/photo-1571019613454-1cb2f99d4db2?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    intro:
      "Design a powerful exercise, from movement cues to equipment requirements.",
  },
  recipe: {
    ...
    intro:
      "Craft a delicious meal, complete with ingredients, allergies, and step-by-step instructions.",
  },
  "mental health": {
    title: "New Wellness Activity",
    emoji: "🧘",
    defaultHeroUrl:
      "https://images.unsplash.com/photo-1557342777-a8a2d1d2b86a?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    intro:
      "Build a guided meditation, breathing exercise, or mindful activity.",
  },
};

const LibraryCreationWrapper: React.FC<CreationWrapperProps> = ({
  children,
  category,
  isEditing,
  onBack,
