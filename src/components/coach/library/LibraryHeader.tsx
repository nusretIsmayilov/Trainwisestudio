...
const LibraryHeader: React.FC<LibraryHeaderProps> = ({
  ...
  return (
    ...
    <div className="sticky top-0 bg-background/95 rounded-md backdrop-blur-sm z-30 pt-6 pb-4 -mx-4 px-4 md:-mx-6 md:px-6">
      {/* Reduced Title Size: text-4xl -> text-3xl */}
      <h1 className="text-3xl font-extrabold mb-3 text-center md:text-left">
        {t("library.title")}{" "}
        {activeCategory ? CATEGORY_MAP[activeCategory].emoji : "📚"}
      </h1>
      <p className="text-sm text-muted-foreground mb-3 text-center md:text-left">
        {t("library.title.helper")}
      </p>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "h-11 rounded-xl flex-shrink-0 border-2 px-4 space-x-2",
                activeCategory
          ...
          <PopoverContent
            className="w-64 p-4 space-y-3 rounded-xl shadow-2xl"
            align="end"
          >
