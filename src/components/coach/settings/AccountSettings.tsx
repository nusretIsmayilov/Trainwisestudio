    ...
    try {
      ...
      const response = await fetch(`${config.api.baseUrl}/coach-payouts`, {
        ...
        body: JSON.stringify({
          ...
          bankDetails: null,
          paypalEmail:
            payoutForm.method === "paypal" ? payoutForm.paypalEmail : null,
          paypalAccountId:
            payoutForm.method === "paypal"
              ? payoutForm.paypalAccountId || null
              : null,
          stripeAccountId:
            payoutForm.method === "stripe" ? payoutForm.stripeAccount : null,
        }),
      });
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-md">
        <CardHeader>
          ...
          <CardDescription>
            Your email and phone number (kept private).
          </CardDescription>
        </CardHeader>
      ...
      <Card className="shadow-md">
        <CardHeader>
          ...
          <CardDescription>
            Where we send your earnings (secure).
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Input
                readOnly
                value={
                  formData.payoutMethod.charAt(0).toUpperCase() +
                  formData.payoutMethod.slice(1)
                }
              />
            </div>
            <p className="text-sm text-muted-foreground">
              Current Details: {formData.payoutDetails}
            </p>
          </div>
                ...
                {payoutForm.method === "paypal" && (
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-muted-foreground mt-1">
                        For business accounts, you can provide your PayPal
                        Merchant ID
                      </p>
                    </div>
                  </div>
        ...
        <CardContent className="space-y-4">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData({
                ...formData,
                preferredLanguage: value as "English" | "Spanish" | "German",
              })
            }
          >
            <SelectTrigger>
