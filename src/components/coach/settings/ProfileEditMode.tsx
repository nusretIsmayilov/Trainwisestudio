    ...
    >
      ...
      <Alert className="border-primary/50 bg-primary/5">
        ...
        <AlertDescription className="text-base">
          <strong>This is your professional storefront.</strong> Showcase your
          expertise and unique value to stand out and attract the right clients!
        </AlertDescription>
      </Alert>
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <img
                src={
                  formData.avatar_url ||
                  "https://placehold.co/100x100/A0E7E5/030712?text=CP"
                }
                alt="Profile"
          ...
          <div>
            ...
            <div className="flex justify-between items-center mt-1">
              ...
              <p className="text-xs text-muted-foreground ml-auto">
                ...
                {formData.bio.length < 100 && "(min 100 recommended)"}
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="shadow-md">
        ...
        <CardContent className="space-y-4">
          {formData.certifications.map((cert) => (
            <div
              key={cert.id}
              className="p-3 border rounded-lg flex items-end gap-3 bg-muted/20"
            >
        ...
        <CardContent className="space-y-4">
          {formData.socials.map((social) => {
            ...
            return (
              <div
                key={social.id}
                className="p-3 border rounded-lg flex items-start gap-3 bg-muted/20"
              >
