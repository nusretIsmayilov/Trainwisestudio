...
const ClientDetailView = ({ client, onClose, loading = false }) => {
  ...
  const showTabs =
    clientStatus &&
    (clientStatus.status === "active" || clientStatus.status === "has_offer");
                  ...
                  <div className="space-y-2">
                    <p className="font-semibold text-muted-foreground">
                      ...
                      <span className="text-foreground">
                        {client.preferences.injuries.join(", ") || "None"}
                      </span>
                    </p>
                    <p className="font-semibold text-muted-foreground">
                      Allergies:{" "}
                    ...
                    <p className="font-semibold text-muted-foreground">
                      Dislikes:{" "}
                      <span className="text-foreground">
                        {client.preferences.dislikes.join(", ") || "None"}
                      </span>
                    </p>
                    <p className="font-semibold text-muted-foreground">
                      Preferred Programs:{" "}
                      <span className="text-foreground">
                        {client.preferences.preferredProgramType.join(", ")}
                      </span>
                    </p>
                  </div>
                </CardContent>
            ...
            <Card className="shadow-lg rounded-xl">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Progress data will be shown here.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
