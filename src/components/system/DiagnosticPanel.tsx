...
export const DiagnosticPanel = () => {
  ...
  const runDiagnostics = async () => {
    ...
    results.push({
      ...
      message: profile
        ...
        : loading
          ...
          : "No profile data",
      details: profile
        ? `Role: ${profile.role}, Onboarding: ${profile.onboarding_complete}`
    ...
    // Check localStorage
    const hasAuthData = localStorage.getItem(
    ...
    results.push({
      ...
      message: hasAuthData
        ? "Authentication data found in localStorage"
          ...
          {errorCount > 0 && (
            <Alert>
              ...
              <AlertDescription>
                ...
                {errorCount === 1 &&
                  diagnostics.find((d) => d.status === "error")?.name ===
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <div className="text-sm text-blue-800 space-y-2">
                ...
                <ol className="list-decimal list-inside space-y-1 ml-4">
                  ...
                  <pre className="bg-blue-100 p-2 rounded text-xs mt-2 whitespace-pre-wrap">
                    {`VITE_SUPABASE_URL=${import.meta.env.VITE_SUPABASE_URL}
VITE_SUPABASE_PUBLISHABLE_KEY=${import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY || "****** (hidden for security)"}
VITE_API_BASE_URL=${import.meta.env.VITE_APP_URL || import.meta.env.PUBLIC_APP_URL || "not set"}`}
                  </pre>
