...
const CurrentCoachTab: React.FC<CurrentCoachTabProps> = ({
  isMobile,
  onViewBio,
  onRequestFeedback,
  onViewSharedFiles,
    ...
    const fetchCoachData = async () => {
      ...
      try {
        ...
        setCoach({
          ...
          bio:
            coachData.bio ||
            "Dedicated to helping you achieve your health and fitness goals.",
      ...
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Loading your coach information...
          </p>
        </div>
      </div>
    );
    ...
    <div className="space-y-8">
      ...
      {isMobile && (
        ...
        >
          ...
          >
            <File className="w-4 h-4 mr-2" /> {t("coach.viewAllFiles")}
          </Button>
        </motion.div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className={cn("lg:col-span-1", isMobile ? "hidden" : "block")}>
          <UnifiedSharedFiles />
        </div>
      </div>
