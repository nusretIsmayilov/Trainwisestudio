...
export const ConversationList: React.FC<ConversationListProps> = ({
  ...
  if (conversations.length === 0) {
    return (
      <div className="p-4">
        <h2 className="text-lg font-semibold mb-4">{t("messages.title")}</h2>
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-3 md:p-4 border-b border-border">
        <h2 className="text-base md:text-lg font-semibold">{t('messages.title')}</h2>
      </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                {conversation.unread_count > 0 && (
                  <div className="flex items-center gap-1">
                    ...
                    <Badge
                      variant="destructive"
                      className="w-4 h-4 sm:w-5 sm:h-5 text-[10px] sm:text-xs rounded-full p-0 flex items-center justify-center"
                    >
