...
const validateField = (name: string, value: any, allValues: any = {}) => {
  switch (name) {
    ...
    case "weight_lbs":
      return value >= 66 && value <= 661
        ? ""
        : "Enter a valid weight (66-661 lbs).";
    case "height_cm":
          ...
          if (units === "metric") {
            ...
            if (field === "weight_lbs") {
              ...
              const feet =
                field === "height_ft"
                  ? numValue
                  : Number(personalInfo.height_ft || 0);
              const inches =
                field === "height_in"
                  ? numValue
                  : Number(personalInfo.height_in || 0);
          ...
          <CardContent className="p-6 sm:p-8 space-y-6">
            ...
            <div className="p-4 bg-gray-50 rounded-lg space-y-4">
              <div className="flex justify-between items-center">
                ...
                >
                  <ToggleGroupItem
                    value="metric"
                    className="rounded-full data-[state=on]:bg-emerald-500 data-[state=on]:text-white px-3"
                  >
                    Metric
                  </ToggleGroupItem>
                  <ToggleGroupItem
              ...
              {units === "metric" ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    label="Height (ft & in)"
                    htmlFor="height_ft"
                    error={errors.height_ft || errors.height_in || ""}
                  >
                    <div className="flex gap-2">
                      <Input
                        ...
                        type="number"
                        placeholder="ft"
                        value={personalInfo.height_ft || ""}
                        onChange={(e) =>
                          handleInputChange("height_ft", e.target.value)
                        }
                      />
                      <Input
                        id="height_in"
                        type="number"
                        placeholder="in"
                        value={personalInfo.height_in || ""}
                        onChange={(e) =>
                          handleInputChange("height_in", e.target.value)
                        }
                      />
                    </div>
                  </FormField>
            ...
            >
              <DateSelector
                ...
                onChange={(part, val) =>
                  handleInputChange("dob", { part, val })
                }
              />
            </FormField>

            <div className="grid grid-cols-2 gap-4">
              <FormField label={t("profile.gender")} htmlFor="gender" error="">
                <Select
