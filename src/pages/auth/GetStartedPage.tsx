      ...
      <AuthLayout>
        <AuthCard>
          <div className="text-center space-y-6">
            ...
            <p className="text-muted-foreground">
              We've sent a magic link to <strong>{form.getValues("email")}</strong>. Click it to continue.
            </p>
            <Button variant="outline" onClick={() => { form.reset(); setIsSuccess(false); }} className="w-full">
